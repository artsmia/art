...
var routes = (
  <Route handler={App} path="/">
    ...
    <Route
      name="accessionHighlight"
      path="art/:id/:slug/accessionHighlight"
      handler={AccessionHighlight}
    />
    <Route
      name="artChampion"
      path="art/:id/:slug/art-champion"
      handler={ArtChampionPage}
    />
    <Route name="sandboxArtwork" path="sandbox/:id" handler={PseudoArtwork} />
    <Route
      name="sandboxArtworkSlug"
