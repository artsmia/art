...
var Curator = React.createClass({
  ...
  render() {
    ...
    if (departmentNames) {
      ...
      var departmentLink = (
        <Link to="department" params={{ dept: departmentSlug }}>
          {curator.department}
        </Link>
      );
    }
        ...
        <div className="curatorProfile pageText">
          ...
          <div className="curatorContent">
            <div className="curatorPic">
              <img
                src={`https://collections.artsmia.org/_info/curator-portraits/${curator.slug}.jpg`}
