  ...
  render() {
    ...
    var votingActions = (
      <div style={{ margin: "1em" }}>
        <a href="#" style={linkStyle} onClick={this.vote.bind(this, "like")}>
          &uarr; I like this
        </a>
        <a href="#" style={linkStyle} onClick={this.vote.bind(this, "dislike")}>
          &darr; I don't like this
        </a>
        <a href="#" style={linkStyle} onClick={this.next}>
          &rarr; skip
        </a>
      </div>
    );
...
var ArtworkSurvey = React.createClass({
  render() {
    var thanksMessage = (
      <div>
        <p>
          Thanks for helping Mia visitors make new connections to diverse
          artworks.
        </p>
        <p>
          <a href="#" onClick={this.incrementProgress}>
            Feel free to keep at it
          </a>
          , but you’ve succeeded in giving us enough data to influence our
          algorithm.
        </p>
...
var VisitorSurvey = React.createClass({
  componentDidMount() {
    ...
    window.serverRendered ||
      restWithCorsCookies(`${SEARCH}/survey/getUserData`).then((result) => {
  ...
  render() {
    ...
    return (
      <section style={{ padding: "1em 2.5em 0 2.5em" }}>
  ...
  surveyWelcome() {
    return (
      <section style={{ margin: "0.5em" }}>
        <h2>
          <strong>Hi</strong>, we're glad you are here.
        </h2>
        <hr />
        ...
        <p style={{ marginTop: "0.5em" }}>
          <a tabIndex="0" onClick={this.cancelSurvey}>
            No thanks.
          </a>
        </p>
      </section>
  ...
  surveyThanks() {
    return (
      <section>
        ...
        <hr />
        <p style={{ marginTop: "1em" }}>
          Your candid feedback will help us improve how people experience our
          website.
        </p>

        <p>
          <button onClick={this.completeSurvey} style={this.buttonStyle()}>
            Close
          </button>
        </p>
      </section>
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      ...
      restWithCorsCookies(
        `${SEARCH}/survey/redesign?data=${JSON.stringify(data)}`
      ).then((result) => {
...
var Survey = React.createClass({
  render() {
    ...
    if (
      (surveyId && surveyId == "2019-visitor-quiz") ||
      surveyId === "2019-survey"
    ) {
