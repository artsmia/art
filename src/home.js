      ...
      <div className="landingPageBody">
        <div className="mdl-grid">
          <ul className="info">
            <li className="mdl-cell mdl-cell--4-col">
              <a href="https://new.artsmia.org/art-artists/">Art + Artists</a>
            </li>
            <li className="mdl-cell mdl-cell--4-col">
              <Link to="/new">New to Mia</Link>
            </li>
            <li className="mdl-cell mdl-cell--4-col">
        ...
        <div className="welcome mdl-grid">
          <div className="mdl-cell mdl-cell--9-col">
            <p>
              ...
              the world’s diverse cultures. With over 90,000 artworks, Mia’s
              ...
              power of human creativity to shape our world.{" "}
            </p>
          </div>
        </div>
        ...
        <div className="mdl-grid">
          <ul className="info">
            {this.pages.map((name) => {
              return (
                <li key={name} className="mdl-cell mdl-cell--3-col">
                  <Link to="page" params={{ name: toSlug(name) }}>
                    {name}
                  </Link>
                </li>
              );
