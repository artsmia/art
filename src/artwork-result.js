  ...
  render() {
    ...
    return (
      <div className='artwork-result'>
        ...
        <h2><Peek facet="artist"><span dangerouslySetInnerHTML={{__html: highlights && (highlights.artist || highlights['artist.ngram']) || art.artist}}></span></Peek></h2>
        <ArtworkImage art={art} id={id} />
        <p><Peek facet="room">{art.room === 'Not on View' ? art.room : <strong>{art.room}</strong>}</Peek></p>
        <div>
