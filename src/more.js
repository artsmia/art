...
var More = React.createClass({
  ...
  componentDidMount() {
    ...
    if (quiltWrap && smallViewport && window.scrollX == 0)
      setTimeout(() => window.scrollTo(0, quiltWrap.clientHeight), 0);
      ...
      <div id="morePage">
        ...
        <div id="more" className="welcome mdl-grid">
          <div className="mdl-cell mdl-cell--9-col">
            <h1>Search to explore audio guides, ArtStories, and more</h1>
            <img src="/images/more.svg" />
            <p className="labelHelper">
              <TombstoneIdeograph />
            </p>
...
var TombstoneIdeograph = React.createClass({
  ...
  render() {
    ...
    var fieldHighlighters = ["title", "artist", "accession number"].map(
      (fieldName) => {
    ...
    return (
      <div>
        <p>
          ...
          <span>{intersperse(fieldHighlighters, ", ")}</span>.
        </p>
